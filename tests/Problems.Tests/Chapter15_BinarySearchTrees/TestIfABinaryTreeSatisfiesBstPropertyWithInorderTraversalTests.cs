...
{
    public class TestIfABinaryTreeSatisfiesBstPropertyWithInorderTraversalTests
    {
        private readonly TestIfABinaryTreeSatisfiesBstPropertyWithInorderTraversal<int> testForBst = new();
