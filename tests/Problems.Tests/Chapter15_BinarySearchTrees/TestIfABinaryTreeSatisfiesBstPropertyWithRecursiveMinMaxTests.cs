...
{
    public class TestIfABinaryTreeSatisfiesBstPropertyWithRecursiveMinMaxTests
    {
        private readonly TestIfABinaryTreeSatisfiesBstPropertyWithRecursiveMinMax<int> testForBst = new();
