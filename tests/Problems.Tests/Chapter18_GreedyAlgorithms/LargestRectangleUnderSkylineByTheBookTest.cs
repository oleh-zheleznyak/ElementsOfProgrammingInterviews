...
{
    public class LargestRectangleUnderSkylineByTheBookTest
    {
        [Theory]
        [MemberData(nameof(TestData))]
        public void ComputeLargestTest(uint[] array, Rectangle expected)
        {
            var sut = new LargestRectangleUnderSkylineByTheBook();
        ...
        private static object[] BookExample()=>
            new object[] { new int[] { 1,4,2,5,6,3,2,6,6,5,2,1,3 }, new Rectangle(1,11,2) };
    }
}